...
public class Gameplay : MonoBehaviour
{
    ...
    {
        if (currentAddCitizensTime < delayAddCitizensTimer && addCitizensButton.interactable == false) // Ñîçäàíèå æèòåëåé
        {
            currentAddCitizensTime += Time.deltaTime;
            citizensDelayLine.fillAmount = currentAddCitizensTime / delayAddCitizensTimer;
        }
        else if (currentAddCitizensTime >= delayAddCitizensTimer && addCitizensButton.interactable == false) // Æèòåëü íàíÿò
        {
    ...
    {
        if (currentAddSoldiersTime < delayAddSoldiersTimer && addSoldiersButton.interactable == false) // Ñîçäàíèå âîèíîâ
        {
            currentAddSoldiersTime += Time.deltaTime;
            soldiersDelayLine.fillAmount = currentAddSoldiersTime / delayAddSoldiersTimer;
        }
        else if (currentAddSoldiersTime >= delayAddSoldiersTimer && addSoldiersButton.interactable == false) // Âîèí íàíÿò
        {
